...
#
# This script will run LAVA for all annotations.
#
# Gokberk Alagoz, 29 June 2022
...
Rscript /data/workspaces/lag/workspaces/lg-genlang/Working/SCRIPTS/23andMe/Dyslexia/dyslexiaevol/clap-beat_dyslexia/LAVA/lava_script.R' $refpanel_1kgp3 $annot $inputInfo $sampleOverlap $phenos $annot > $tmp_run_file
