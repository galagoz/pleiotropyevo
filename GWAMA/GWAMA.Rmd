...
```{r ModelAveraged, echo=FALSE}

# Calculate Z-scores from Beta. Z scores are needed for LDSC munge,

dys_MA$Z = dys_MA$Beta*(sqrt(dys_MA$N*2*dys_MA$EAF*(1-dys_MA$EAF)))
rhy_MA$Z = rhy_MA$Beta*(sqrt(rhy_MA$N*2*rhy_MA$EAF*(1-rhy_MA$EAF)))

#fwrite(dys_MA,"/data/clusterfs/lag/users/gokala/beat-dyslexiaevol/data/dyslexia_reformatted_forModelAveraged_forMunge.tab",showProgress=F,quote=F,sep="\t")
#fwrite(rhy_MA,"/data/clusterfs/lag/users/gokala/beat-dyslexiaevol/data/rhythym_reformatted_forModelAveraged_forMunge.tab",showProgress=F,quote=F,sep="\t")
