...
dat<-vector("list",2)
dat[[1]]<-fread("/data/clusterfs/lag/users/gokala/beat-dyslexiaevol/data/dyslexia_forNweighted.txt",showProgress=F,data.table=F)
dat[[2]]<-fread("/data/clusterfs/lag/users/gokala/beat-dyslexiaevol/data/rhythm_impairment_forNweighted.txt",showProgress=F,data.table=F)
...
multivariate_GWAMA(x = dat, 
                   ...
                   name = "dyslexia_rhythmImpairment", 
                   output_gz = F, 
                   check_columns = F)
