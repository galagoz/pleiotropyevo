...
awk 'NR>1 {print $19, $16, $17, $25, $24, $20, $7+$8, $4, $5, $3}' ${sumstats}dyslexia.filtered.2_lambdaGCcorrected.dat > ${sumstats}dyslexia_forgenomicSEM1.txt
...
#awk 'NR>1 {print $42, $37, $24, $39, $38, $18, $7+$9, $4, $5, $3}' ${sumstats}rhythm_impairment_lambdaGCcorrected.dat > ${sumstats}rhythm_impairment_forgenomicSEM1.txt
