#!/bin/bash
#
# Gokberk Alagoz, March 2022 - last updated Nov 2022
#
#-----
#PATHS
...
#-----
# 3) Meta-analysis (Genomic SEM common factor)

# Without liability scale
ldsc.py \
 --h2 ${mungedDir}GenomicSEM_multivarGWAS_dys_rhyimp.sumstats.gz \
 --ref-ld-chr ${ldscores} \
 --out ${outDir}GenomicSEM_multivarGWAS_dys_rhyimp_heritability \
 --w-ld-chr ${ldscores}
...
ldsc.py \
 ...
 --pop-prev 0.0488 \
 --samp-prev 0.065 \
 --out ${outDir}GenomicSEM_multivarGWAS_dys_rhyimp_popPrev0.0488_sampPrev0.065_heritability \
 --w-ld-chr ${ldscores}
