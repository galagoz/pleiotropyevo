...
--overlap-annot \
--ref-ld-chr /data/clusterfs/lag/users/gokala/beat-dyslexiaevol/resources/new_annotations/${fannot}/${annot}.,/data/clusterfs/lag/users/gokala/beat-dyslexiaevol/resources/new_annotations/${fbaseline}/${fbaseline}.,/data/clusterfs/lag/users/gokala/beat-dyslexiaevol/resources/baselineLD/baselineLD. \
